...
public class JDlgVendasProdutos extends javax.swing.JDialog {
    ...
    public JDlgVendasProdutos(java.awt.Frame parent, boolean modal) {
        ...
        for (int i = 0; i < lista.size(); i++) {
           jCboProdutos.addItem((Produtos) lista.get(i)); 
    }
    ...
    public PedidosProdutos viewBean(){
     ...
     pedidosProdutos.setValorUnitario(Util.strInt(jTxtValor.getText()));
    ...
    public void setTelaAnterior(JDlgPedidos jDlgPedidos) {
      ...
      public void beanView(PedidosProdutos pedidosProdutos) {
        
        jTxtQuantidade.setText(Util.intStr(pedidosProdutos.getQuantidade()));  
        jTxtTotal.setText(Util.doubleStr(pedidosProdutos.getValorUnitario()));
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        if (getTitle().toUpperCase().substring(0, 1).equals("I")) {
            ...
            jdlgPedidos.pedidosProdutosControle.updateBean(jdlgPedidos.getSelectedRow(), pedidosProdutos);
        }
        setVisible(false);
